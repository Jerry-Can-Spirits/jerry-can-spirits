# Jerry Can Spirits — Voice and Tone

This document is binding for all customer-facing words: website copy, email, social, packaging, press, and product listings. `CLAUDE.md` carries a short version of the hard rules; this file is the full reference. Read it before writing any copy.
