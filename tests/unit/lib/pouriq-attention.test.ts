...
function ingredient(opts: { price_p?: number }): IngredientWithLibrary {
  const library: IngredientLibraryRow = {
    ...
    base_unit: 'each', pack_size: 1, price_p: opts.price_p ?? 0, price_includes_vat: 0, price_entered_p: null, pack_format: null, subcategory: null,
    is_prepared: 0,
    purchase_qty: 1,
    yield_pct: 100,
  ...
  return { id: 'ing', cocktail_id: 'c', library_ingredient_id: 'lib', pour_ml: null, unit_count: 1, recipe_unit: null, recipe_qty: null, use_id: null, use: null, library }
}
