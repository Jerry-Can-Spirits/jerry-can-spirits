    ...
    <section className="py-16 bg-jerry-green-900/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {/* Charity Donation */}
          <div className="bg-linear-to-br from-gold-500/10 to-gold-600/5 backdrop-blur-sm rounded-xl p-6 border border-gold-500/30 text-center">
            ...
            <h3 className="text-2xl font-serif font-bold text-gold-300 mb-2">5%</h3>
            <p className="text-white font-semibold mb-2">Of Profits</p>
