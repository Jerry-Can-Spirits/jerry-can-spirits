      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-jerry-green-900 border border-gold-500/30 rounded-lg text-white placeholder-parchment-500 text-base focus:outline-hidden focus:border-gold-400"
          />
        </div>
        <div>
          ...
          {bottles.map((bottle, i) => (
            <div key={i} className="flex gap-2 items-center">
              <select
                ...
                className="px-3 py-3 bg-jerry-green-900 border border-gold-500/30 rounded-lg text-white text-base focus:outline-hidden focus:border-gold-400"
              >
                {BOTTLE_TYPES.map((t) => (
              ...
              <input
                ...
                className="w-32 px-3 py-3 bg-jerry-green-900 border border-gold-500/30 rounded-lg text-white placeholder-parchment-500 text-base focus:outline-hidden focus:border-gold-400"
              />
              {bottles.length > 1 && (
                <button
                  type="button"
