...
const awardItems: AwardItem[] = [
  ...
  // The IWSC medals are deliberately absent: the hero headline claims them and
  // the MedalBar directly below it states them in full. Listing them a third
  // time here is the "mentioned three times it becomes hype" case VOICE names.
]
