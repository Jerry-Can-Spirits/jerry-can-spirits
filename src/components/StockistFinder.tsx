        ...
        <div>
          ...
          <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-2 mb-3">
            <input
              ...
              maxLength={8}
              className="flex-1 px-4 py-3 bg-jerry-green-900 border border-gold-500/30 rounded-lg text-white placeholder-parchment-500 text-base focus:outline-hidden focus:border-gold-400 uppercase tracking-wider"
            />
            <button
              type="submit"
