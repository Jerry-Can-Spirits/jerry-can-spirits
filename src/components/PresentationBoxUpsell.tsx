...
export default function PresentationBoxUpsell() {
  ...
  return (
    // Compact gift-context offer: no image, no card chrome — a lean two-row
    // block so it stops competing with the accessory upsell for space. Keeps the
    // per-bottle quantity cap and the rum-in-cart gate.
    <div className="py-4 border-t border-gold-500/20">
      ...
      <div className="flex items-center gap-3 mt-3">
        ...
        <button
          ...
          className="ml-auto px-4 min-h-[44px] bg-gold-500 hover:bg-gold-400 text-jerry-green-900 text-sm font-semibold rounded-sm transition-colors disabled:opacity-50"
        >
