...
export const STATIC_SEARCH_PAGES: SearchResult[] = [
  ...
  { type: 'page', title: 'British Spiced Rum', description: 'Small-batch British spiced rum pot-distilled in the UK. Real spices, no artificial flavourings.', url: '/shop/spiced-rum/', category: 'Shop', keywords: 'british spiced rum small batch veteran craft 40% abv 700ml buy uk' },
