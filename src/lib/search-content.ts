...
export const STATIC_SEARCH_PAGES: SearchResult[] = [
  ...
  { type: 'page', title: 'The Expedition Log', description: 'A public record of the people who bought the first bottles', url: '/expedition-log/', category: 'About', keywords: 'first bottle registry log community join expedition record name' },
  // Resources
  ...
  { type: 'page', title: 'British Spiced Rum', description: 'Small-batch British spiced rum. Real spices, no artificial flavourings.', url: '/shop/spiced-rum/', category: 'Shop', keywords: 'british spiced rum small batch veteran craft 40% abv 700ml buy uk' },
  ...
  { type: 'page', title: 'Bar Accessories', description: 'Bar accessories for a proper home bar. Cocktail shakers, jiggers, and glassware. Built to last.', url: '/shop/bar-accessories/', category: 'Shop', keywords: 'bar accessories uk home bar tools shaker jigger glassware equipment' },
  ...
  { type: 'page', title: 'Rum Glasses', description: 'The right glass makes a difference. Rum glasses selected for Expedition Spiced Rum.', url: '/shop/rum-glasses/', category: 'Shop', keywords: 'rum glasses uk best glass for rum highball tumbler glassware' },
  { type: 'page', title: 'Hip Flasks', description: 'Stainless steel hip flasks. Built for the field, seals properly, no shortcuts.', url: '/shop/hip-flasks/', category: 'Shop', keywords: 'hip flask uk stainless steel hip flasks gift pocket flask spirits' },
  { type: 'page', title: 'Ice and Chilling', description: 'Spirit stones and chilling accessories. Keep your drink cold without diluting it.', url: '/shop/ice-chilling/', category: 'Shop', keywords: 'whisky stones spirit stones chilling accessories ice no dilution freezer' },
  { type: 'page', title: 'Cocktail Glasses', description: 'Cocktail glasses for the home bar. Highballs, tumblers, hurricane glasses and mixer glasses.', url: '/shop/cocktail-glasses-glassware/', category: 'Shop', keywords: 'cocktail glasses uk highball tumbler hurricane mixer glass home bar glassware' },
  { type: 'page', title: 'Cocktail Shakers', description: 'Stainless steel cocktail shakers. Seals properly, chills properly, built to last.', url: '/shop/cocktail-shakers/', category: 'Shop', keywords: 'cocktail shaker uk stainless steel shaker home bar cocktail kit' },
  { type: 'page', title: 'What’s In It: Expedition Spiced Rum', description: 'What goes into Expedition Spiced Rum. Our full ingredient breakdown.', url: '/ingredients/expedition-spiced-rum/', category: 'Product', keywords: 'expedition rum recipe spices vanilla cinnamon what is in ingredient list' },
  // Support & Contact
