...
export const STATIC_SEARCH_PAGES: SearchResult[] = [
  ...
  { type: 'page', title: 'Hip Flasks UK', description: 'Stainless steel hip flasks. Built for the field, seals properly, no shortcuts.', url: '/shop/hip-flasks/', category: 'Shop', keywords: 'hip flask uk stainless steel hip flasks gift pocket flask spirits' },
  ...
  { type: 'page', title: 'Cocktail Glasses UK', description: 'Cocktail glasses for the home bar. Highballs, tumblers, hurricane glasses and mixer glasses.', url: '/shop/cocktail-glasses-glassware/', category: 'Shop', keywords: 'cocktail glasses uk highball tumbler hurricane mixer glass home bar glassware' },
  { type: 'page', title: 'Cocktail Shakers UK', description: 'Stainless steel cocktail shakers. Seals properly, chills properly, built to last.', url: '/shop/cocktail-shakers/', category: 'Shop', keywords: 'cocktail shaker uk stainless steel shaker home bar cocktail kit' },
