...
export default async function SpiritsPage() {
  ...
  try {
    // The whole Shopify spirits collection, six-bottle Expedition Pack
    // included. An undocumented filter used to hide the pack here — a relic
    // of when it was treated as trade-only. Its product page always said
    // customers could buy it; now the collection agrees (Dan, 31 Aug 2026).
  ...
  // Error state — branded, no raw error or platform name, with a retry.
  if (error) {
    return <ShopError />
  }
