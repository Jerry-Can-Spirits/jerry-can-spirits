...
export default function FirstPourPage() {
  return (
    <main>
      {/* Hero, with the cover and the signup form. The form reports its
          errors in text-red-400, so it stays on the dark ground. */}
      <section className="band-dark pt-20 pb-16">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            as="h1"
            eyebrow="The companion book"
            intro="First Pour is the short companion to ours. How it is built, how to drink it, and the first cocktails worth your time."
          >
      ...
      <section className="band-light py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            ...
            <ScrollRow
              ariaLabel="What is inside the book"
              cols="md:grid-cols-3"
              items={[
                <div key="built" className="h-full text-center">
                ...
                <div key="drink" className="h-full text-center">
                  <div className="text-gold-300 text-sm font-semibold uppercase tracking-widest mb-3">
                    How to drink it
                  </div>
                  <p className="text-parchment-300">
                ...
                <div key="cocktails" className="h-full text-center">
                  <div className="text-gold-300 text-sm font-semibold uppercase tracking-widest mb-3">
                    First cocktails
                  </div>
                  <p className="text-parchment-300">
