  ...
  return (
    ...
    >
      ...
      <TradeSheetSection title="What we make">
        <p className="text-sm leading-relaxed mb-3">
          Expedition Spiced Rum, the first release, is a Caribbean-base spiced rum macerated by our British partner distillery. 40% ABV. 700ml. Vegan, gluten-free, no declared allergens. Seven real spices: Madagascan vanilla, Ceylon cinnamon, Peruvian ginger, Spanish orange peel, Sri Lankan cloves, Guatemalan allspice, Indonesian cassia bark. Two natural sweeteners: Mexican agave syrup and Sussex glucose syrup. Rested on bourbon barrel chips for depth. No essences, no artificial flavourings.
        </p>
        <p className="text-sm leading-relaxed">
