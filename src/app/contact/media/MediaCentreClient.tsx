              ...
              <div className="bg-jerry-green-800/40 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-gold-500/20">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    // RRP is read live from Shopify by the server page and
                    // passed down — never hardcoded (Audit 8 PR B).
                    ...(rrp ? [{ label: 'RRP', value: rrp }] : []),
            ...
            <ImageGallery images={[
              {
                ...
                downloads: [
                  { label: 'PNG', url: '/api/media-download/?id=beed84d3-c77d-4ecf-c85f-29719bdea000&format=png&filename=expedition-spiced-rum-shot-1.png' },
                  { label: 'JPG', url: '/api/media-download/?id=beed84d3-c77d-4ecf-c85f-29719bdea000&format=jpeg&filename=expedition-spiced-rum-shot-1.jpg' },
                  { label: 'WebP', url: '/api/media-download/?id=beed84d3-c77d-4ecf-c85f-29719bdea000&format=webp&filename=expedition-spiced-rum-shot-1.webp' },
                ],
              },
              {
                ...
                downloads: [
                  { label: 'PNG', url: '/api/media-download/?id=fffd5ce1-6411-4ab4-6c32-aacf2caa1700&format=png&filename=expedition-spiced-rum-shot-2.png' },
                  { label: 'JPG', url: '/api/media-download/?id=fffd5ce1-6411-4ab4-6c32-aacf2caa1700&format=jpeg&filename=expedition-spiced-rum-shot-2.jpg' },
                  { label: 'WebP', url: '/api/media-download/?id=fffd5ce1-6411-4ab4-6c32-aacf2caa1700&format=webp&filename=expedition-spiced-rum-shot-2.webp' },
                ],
              },
              {
                ...
                downloads: [
                  { label: 'PNG', url: '/api/media-download/?id=8ad4c4c5-6c38-4342-c42a-652af5529f00&format=png&filename=expedition-spiced-rum-shot-3.png' },
                  { label: 'JPG', url: '/api/media-download/?id=8ad4c4c5-6c38-4342-c42a-652af5529f00&format=jpeg&filename=expedition-spiced-rum-shot-3.jpg' },
                  { label: 'WebP', url: '/api/media-download/?id=8ad4c4c5-6c38-4342-c42a-652af5529f00&format=webp&filename=expedition-spiced-rum-shot-3.webp' },
                ],
              },
            ]} />
          </section>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="relative border-l-2 border-gold-500/30 ml-4">
                {[
                  ...
                  // Q3 2025 recipe-development entry removed: the partner at that
                  // date was the former producer, so the sentence could not be made
                  // true under the current provenance rules.
