    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": `Standard shipping costs ${STANDARD_SHIPPING_LABEL}. Orders over £${FREE_SHIPPING_THRESHOLD_GBP} qualify for free shipping. We currently ship throughout the United Kingdom.`
        }
      },
      {
        "@type": "Question",
            ...
            <section className="bg-jerry-green-800/40 backdrop-blur-sm rounded-lg p-6 border border-gold-500/20">
              ...
              <div className="bg-jerry-green-800/40 backdrop-blur-sm rounded-lg p-6 border border-gold-500/20">
                <ul className="list-disc list-inside text-white space-y-2">
                  <li><strong className="text-gold-300">Standard Shipping</strong>: {STANDARD_SHIPPING_LABEL}</li>
